...
try: 
    ...
    #input1 = browser.find_element(By.XPATH, "//input[contains(@class, 'first')]")
    ...
    input1.send_keys("Valerii")
    #input2 = browser.find_element(By.XPATH, "//input[contains(@class, 'second')]")
    ...
    input3.send_keys("Valerii@mail.ru")
